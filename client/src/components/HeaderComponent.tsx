export function HeaderComponent() {
  return (
    <>
      <div className="py-12 w-full flex flex justify-center items-center gap-12">
        <div className=" flex flex justify-between items-center flex-col gap-8">
          ...
          <div className="flex gap-12">
            ...
            <button className="bg-emerald-100 py-3 px-6 rounded-md text-emerald-800 hover:bg-emerald-300 hover:text-emerald-900">
              <p className="font-light">
        ...
        <div className="h-[100%] w-1/2 overflow-hidden">
          <img src="/src/assets/image/superheroBanneer.jpg" alt="" className="rounded-3xl" />
        </div>
      </div>
    </>
  );
